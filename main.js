document.addEventListener("DOMContentLoaded", function () {
    ...
    // Fermer le menu mobile lorsqu'un item est cliqué
    ...
    // Mise à jour des valeurs des color pickers
    ...
    function drawIcon() {
        ...
        const strokeWidth = parseInt(
            document.getElementById("icon-stroke-width").value
        );
    ...
    document
        .getElementById("generate-icon")
        .addEventListener("click", drawIcon);
    ...
    function drawShape() {
        ...
        const borderRadius = parseInt(
            document.getElementById("shape-border-radius").value
        );
        ...
        const strokeWidth = parseInt(
            document.getElementById("shape-stroke-width").value
        );
        ...
        switch (shapeType) {
            ...
            case "polygon":
                const sides = parseInt(
                    document.getElementById("polygon-sides").value
                );
    ...
    document
        .getElementById("generate-shape")
        .addEventListener("click", drawShape);

    document
        .getElementById("download-shape")
        .addEventListener("click", function () {
    ...
    function generateImage() {
        ...
        const complexity = parseInt(
            document.getElementById("image-complexity").value
        );
    ...
    function generatePattern(width, height, color1, color2, complexity) {
        const size = Math.max(
            10,
            Math.floor(Math.min(width, height) / (complexity * 2))
        );
